...
geo_analysis, Device_analysis, payment_analysis, transac_yearwise,Overall_India_Analysisst = st.tabs(["Geographical analysis","User device analysis","Overall_India_Analysis","Payment Types analysis", "Transacion analysis of States"])
